...
// TODO: change uri to env file....
const MONGODB_URI =
  'mongodb+srv://eeva:laikku111@cluster0.txhf8.mongodb.net/word-to-word?retryWrites=true&w=majority'
...
const resolvers = {
  ...
  Mutation: {
    ...
    createChallenge: (root, args) => {
      const challenge = new Challenge({ name: args.name, description: args.description || null  })
